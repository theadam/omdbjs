...
STANDALONE = $(BROWSERIFY) --standalone omdbjs $(STANDALONE_BROWSERIFY_ARGS)
...
browser: dist/omdbjs.min.js

dist/omdbjs.js: compile | mkdist
	$(STANDALONE) lib/index.js > dist/omdbjs.js

dist/omdbjs.min.js: dist/omdbjs.js
	$(UGLIFY) dist/omdbjs.js > dist/omdbjs.min.js
